...
const STOR_PRERESPONSE = "150 Opening BINARY mode data connection for file upload\n"
const RETR_PRERESPONSE = "150 Opening BINARY mode data connection for '%s' (%d bytes).\n"
